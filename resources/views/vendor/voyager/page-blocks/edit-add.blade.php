                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" id="type">
                                    ...
                                    <optgroup label="Block Templates">
                                         <option value="template|content_one_column">Content - 1 Column/s </option>
                                         <option value="template|content_two_columns"> Content - 2 Column/s</option>
                                         <option value="template|content_three_columns">Content - 3 Column/s</option>
                                         <option value="template|content_four_columns">Content - 4 Column/s</option>
                                    </optgroup>
                                </select>
                            </div> <!-- /.form-group -->
...
<iframe id="form_target" name="form_target" style="display:none"></iframe>
 <form id="my_form" action='{{url("/admin/upload")}}' target="form_target" method="post" enctype="multipart/form-data" style="width:0;height:0;overflow:hidden">
   <input name="image" id="upload_file" type="file" onchange="$('#my_form').submit();this.value='';">
   <input type="hidden" name="type_slug" id="type_slug" value="newsletter">
