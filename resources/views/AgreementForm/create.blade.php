            ...
            <div class="row">
                <div class="col-md-6 form-group">
                 ...
                 <div class="col-md-4 form-group">
                    ...
                    <input type="text" class="form-control" name="ZIPCode" onkeypress="return isNumber(event)" oncopy="return false" onpaste="return false">
                 </div>
                 <div class="col-md-12 form-group" style="display:none">
                    <label>Confidential Statement</label>
                    <textarea name="ConfidentialStatement" rows="4" class="form-control" cols="75" spellcheck="false"></textarea>
                 </div>

                 <div class="col-md-12 form-group">
                    <label>Sign Initial *</label>
                    <input type="text" class="form-control" name="SignInitial">
                 </div>
                 ...
                 <div class="col-md-12">
                    <div class="checkbox">
                         <div class="form-group">
                             <input type="checkbox" id="TermsConditions" name="TermsConditions" value="1" onclick="CallConfidentialStatement('get')"> <span>I have read and agree to the terms &amp; conditions</span>
                         </div>
                    </div>
